package lms.kiu.notifier.tests.telegram.bot.service;

import static lms.kiu.notifier.tests.data.Constants.INVALID_TIME_PERIOD_ERROR;
import static lms.kiu.notifier.tests.data.Constants.REGISTRATION_HELPER_MESSAGE;
