package lms.kiu.notifier.tests.telegram.bot;

import static lms.kiu.notifier.tests.data.Constants.ABOUT_MESSAGE;
import static lms.kiu.notifier.tests.data.Constants.HELP_MESSAGE;
import static lms.kiu.notifier.tests.data.Constants.WELCOME_MESSAGE;
import static lms.kiu.notifier.tests.utils.MessageUtils.hasMessageWith;
