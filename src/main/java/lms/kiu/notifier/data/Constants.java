...
public class Constants {
  ...
  public static final String INVALID_TIME_PERIOD_ERROR = "⚠️ Invalid number format. Please enter a valid number for the time period.";
  ...
  public static final String FAILED_CHECKING_NEWS_ERROR = "Failed to check news. Please try again later.";
  ...
  public static final String REGISTRATION_GROUP_ID_URL_PATH = "/student/registration/group/getGroupForRegistration";
